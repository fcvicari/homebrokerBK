...
describe('UsersModule Test', () => {
  ...
  it('should register OrdersController', () => {
    const prismaService = moduleRef.get<OrdersController>(OrdersController);
  ...
  it('should register OrderRepository provider', () => {
    const assetRepository = moduleRef.get<OrderRepository>(OrderRepository);
    expect(assetRepository).toBeDefined();
  });
});
